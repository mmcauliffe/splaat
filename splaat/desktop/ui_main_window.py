...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionExport_modified_files = QAction(MainWindow)
        self.actionExport_modified_files.setObjectName("actionExport_modified_files")
        ...
        self.menuSave.addAction(self.actionExport_modified_files)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionExport_modified_files.setText(
            QCoreApplication.translate("MainWindow", "Export modified files...", None)
        )
        ...
        self.menuSave.setTitle(QCoreApplication.translate("MainWindow", "Save", None))
