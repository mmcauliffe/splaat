...
class Ui_FileDetailWindow(object):
    def setupUi(self, FileDetailWindow):
        ...
        self.actionZoomAll = QAction(FileDetailWindow)
        self.actionZoomAll.setObjectName("actionZoomAll")
        self.actionZoomAll.setMenuRole(QAction.NoRole)
        ...
        self.toolBar.addAction(self.actionZoomAll)
    ...
    def retranslateUi(self, FileDetailWindow):
        ...
        self.actionZoomAll.setText(QCoreApplication.translate("FileDetailWindow", "All", None))
        # if QT_CONFIG(tooltip)
        self.actionZoomAll.setToolTip(
